...
export function Section({ children, ...props }: SectionProps) {
  ...
  return (
    <CanvasWrapper {...props} layout={{ minHeight: showEmpty ? "400px" : undefined, ...props.layout }}>
...
export function CanvasRoot({ children }: { children?: ReactNode }) {
  ...
  return (
    <div className={enabled ? "min-h-[720px] w-full" : "flex min-h-[var(--pb-viewport-fill,100dvh)] w-full flex-1 flex-col"} style={{ background: "inherit" }}>
      {showEmpty ? (
        <div className="p-6">
