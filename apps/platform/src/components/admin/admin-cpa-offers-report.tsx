  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        <GradientStatCard
          label="Matching conversions"
          value={loading ? "…" : total}
          icon={Activity}
          variant="approved"
        />
        <GradientStatCard
          label="Payout on this page"
          value={loading ? "…" : formatCurrency(pageStats.payoutSum)}
          icon={DollarSign}
          variant="revenue"
        />
        <GradientStatCard
          label="Offers on this page"
          value={loading ? "…" : pageStats.uniqueOffers}
          icon={Store}
          variant="leads"
        />
      </div>
