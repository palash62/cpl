...
export function AdminCampaignEditForm({ campaign }: AdminCampaignEditFormProps) {
  ...
  const [publisherAccess, setPublisherAccess] = useState(campaign.publisherAccess);
  const [autoApprove, setAutoApprove] = useState(campaign.autoApprove);
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Select value={publisherAccess} onValueChange={(v) => v && setPublisherAccess(v)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
